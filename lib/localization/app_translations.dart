...
// category samples
          ...
          'car_vehicle_photo_sub':
              'Add your Vehicle photo here, and you can upload up to 5 files max',
          'car_vehicle_insurance':
              'Add your Vehicle photo here, and you can upload only one file',
          'car_vehicle_reg': 'Vehicle Registration Sticker Upload',
          'car_vehicle_reg_sub':
              'Add your Vehicle Registration Sticker photo here, and you can upload only one file',
...
// ===== en_US additions =====
        ...
        'bn_BD': {
          ...
          'confirm':
              'বাতিল নিশ্চিত করুন', // If you prefer just "Confirm": 'নিশ্চিত করুন'
          'go_back': 'ফিরে যান',
          ...
          'apartment_suite_unit_optional':
              'অ্যাপার্টমেন্ট, সুইট, ইউনিট (ঐচ্ছিক)',
          // ----- Common -----
          'back': 'পিছনে',
          'powered':
              'Powered By SafeCare24/7 Medical Services Limited\nBeta Version 1.0',
...
// ----- Bottom sheets (When / Contact / Service) -----
          ...
          'signup_subtitle':
              'সেকেন্ডের মধ্যে সাইন আপ করুন বা জরুরি সেবা বুক করুন।',
...
// category samples
          ...
          'car_vehicle_photo_sub':
              'যানবাহন আপনার গাড়ির ছবি এখানে যোগ করুন, এবং আপনি সর্বোচ্চ ৫টি ফাইল আপলোড করতে পারবেন।',
          'car_vehicle_insurance':
              'আপনার যানবাহনের বীমার ছবি এখানে যোগ করুন, এবং আপনি সর্বোচ্চ ১টি ফাইল আপলোড করতে পারবেন',
          'car_vehicle_reg': 'যানবাহনের রেজিস্ট্রেশন স্টিকার আপলোড',
          'car_vehicle_reg_sub':
              'আপনার যানবাহন নিবন্ধন স্টিকার ছবি এখানে যোগ করুন, এবং আপনি সর্বোচ্চ 1টি ফাইল আপলোড করতে পারবেন',
...
// ===== bn_BD additions =====
          'waiting_approval_title':
              'আপনার আবেদন জমা দেওয়া হয়েছে এবং পর্যালোচনাধীন।',
          'waiting_approval_body':
          ...
          'err_file_pick':
              'ফাইল নির্বাচন করা যায়নি। অনুগ্রহ করে আবার চেষ্টা করুন।',
